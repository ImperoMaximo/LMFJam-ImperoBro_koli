...
public class bambooLadderVine extends VineBlock implements net.minecraftforge.common.IForgeShearable {
	   ...
	   public bambooLadderVine(AbstractBlock.Properties properties) {
	      super(properties);
	      ...
	      this.stateToShapeMap = ImmutableMap.copyOf(this.stateContainer.getValidStates().stream().collect(Collectors.toMap(Function.identity(), bambooLadderVine::getShapeForState)));
	   }
	            ...
	            if (direction == Direction.UP && pos.getY() < 255) {
	               ...
	               if (worldIn.isAirBlock(blockpos)) {
	                  ...
	                  for(Direction direction2 : Direction.Plane.HORIZONTAL) {
	                     if (!canAttachTo(worldIn, blockpos.offset(direction2), Direction.UP)) {
