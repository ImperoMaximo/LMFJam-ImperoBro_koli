...
public class EmergencyVineBlock extends VineBlock implements net.minecraftforge.common.IForgeShearable {
	   ...
	   public EmergencyVineBlock(AbstractBlock.Properties properties) {
	      super(properties);
	      ...
	      this.stateToShapeMap = ImmutableMap.copyOf(this.stateContainer.getValidStates().stream().collect(Collectors.toMap(Function.identity(), EmergencyVineBlock::getShapeForState)));
	   }
	   ...
	   public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
	      if (worldIn.rand.nextInt(1) == 0 && worldIn.isAreaLoaded(pos, 4)) { // Forge: check area to prevent loading unloaded chunks
