...
public class SRTDItems	{
    ...
    public static final RegistryObject<Item> Cereal = Items.register("cereal", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> Chocolate_bar = Items.register("chocolate_bar", () -> new Item(new Item.Properties().group(SRTDItemsGroup.srtd).food(new Food.Builder().hunger(5).saturation(0.8F).effect(() -> new EffectInstance(Effects.JUMP_BOOST, 20*120, 0), 1f).build())))));
    public static final RegistryObject<Item> Apple_bar = Items.register("apple_bar", () -> new Item(new Item.Properties().group(SRTDItemsGroup.srtd).food(new Food.Builder().hunger(5).saturation(0.8F).effect(() -> new EffectInstance(Effects.SPEED, 20*120, 0), 1f).build()))))); 
    ...
    public static final RegistryObject<Item> Growing_bamboo_ladder = Items.register("growing_bamboo_ladder", () -> new BlockItem(SRTDBlocks.Emergency_vine.get(), (new Item.Properties()).group(SRTDItemsGroup.srtd).maxStackSize(1)));
}