...
public class SRTDItems	{
    ...
    public static final RegistryObject<Item> Chocolate_bar = Items.register("chocolate_bar", () -> new Item(new Item.Properties()
            .group(SRTDItemsGroup.srtd)
            .food(new Food.Builder().hunger(6).saturation(0.9F).effect(() -> new EffectInstance(Effects.SPEED, 20 * 120, 0), 1.0f).build())));
    public static final RegistryObject<Item> Apple_bar = Items.register("apple_bar", () -> new Item(new Item.Properties()
            .group(SRTDItemsGroup.srtd)
            .food(new Food.Builder().hunger(6).saturation(0.9F).effect(() -> new EffectInstance(Effects.HASTE, 20 * 120, 0), 1.0f).build())));
}